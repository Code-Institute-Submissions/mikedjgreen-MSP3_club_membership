...
upd_artwork = coll.update_one({"year": "2021"},
                              {"$addToSet": {"artworks": { "art_id": ObjectId("5fc7c0708c7f8137fd7e3d05"),
                                                         "artist": "Mike Green",
                                                         "title": "Torso",
                                                         "media": "soft pastels",
                                                         "height": 16.0,
...
upd_artwork = coll.update_one({"year": "2021"},
                              {"$addToSet": {"artworks": {  "art_id": ObjectId("5fc7c0718c7f8137fd7e3d06"),
                                                          "artist": "Mike Green",
                                                          "title": "Therapy",
                                                          "media": "soft pastels",
                                                          "height": 16.0,
...
upd_artwork = coll.update_one({"year": "2021"},
                              {"$addToSet": {"artworks": {  "art_id": ObjectId("5fc7c0718c7f8137fd7e3d07"),
                                                            "artist": "Mike Green",
                                                          "title": "Becca",
                                                          "media": "soft pastels",
                                                          "height": 10.0,
